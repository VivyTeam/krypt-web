!(function(t, e) {
  ...
  return (function(t) {
      ...
      var n = r(0),
        ...
        a = function(t, e, r) {
          var s,
            ...
            g = h ? o : o[e] || (o[e] = {}),
            w = g.prototype,
            b = h ? n : d ? n[e] : (n[e] || {}).prototype;
          for (s in (h && (r = e), r))
            ((f = !p && b && void 0 !== b[s]) && c(g, s)) ||
              ((l = f ? b[s] : r[s]),
              (g[s] =
    ...
    function(t, e, r) {
      ...
      t.exports = function(t, e, r, d, v, y, m) {
        a(r, e, d);
        var g,
          w,
          b,
          ...
          O = S || x(v),
          j = v ? (E ? x("entries") : O) : void 0,
          L = ("Array" == e && T.entries) || S;
        if (
          (L &&
            (b = f(L.call(new t()))) !== Object.prototype &&
            b.next &&
            (s(b, _, !0), n || "function" == typeof b[l] || u(b, l, h)),
          E &&
            S &&
            "values" !== S.name &&
            ((A = !0),
    ...
    function(t, e, r) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.concatenateUint8Arrays = e.generateInitialVector = e.decode = e.encode = void 0);
      var n,
        o = u(r(23)),
        i = u(r(24));
      e.generateInitialVector = ((n = (0, i.default)(
      ...
      (e.stringToArrayBuffer = s),
        (e.arrayBufferToString = f),
        (e.base64ToArrayBuffer = l),
        (e.arrayBufferToBase64 = function(t) {
          var e = f(t);
          return c(e);
        }),
        (e.toPem = function(t) {
          for (var e = f(t), r = c(e), n = "\n", o = 0; o < r.length; o += 64) {
            var i = r.slice(o, o + 64);
            n += i + "\n";
          }
          return "-----BEGIN PUBLIC KEY-----" + n + "-----END PUBLIC KEY-----";
        }),
        (e.toArrayBuffer = function(t) {
          return l(
            t
      ...
      var c = (e.encode = function(t) {
          return btoa(t);
        }),
        a = (e.decode = function(t) {
          return atob(t);
        });
      function s(t) {
        for (var e = t.length, r = new Uint8Array(e), n = 0; n < e; n += 1)
          r[n] += t.charCodeAt(n);
        return r.buffer;
      }
      function f(t) {
      ...
      e.concatenateUint8Arrays = function() {
    ...
    function(t, e, r) {
      ...
      var n = r(43);
      e.default = {
        medEncrypt: n.encrypt,
        medDecrypt: n.decrypt,
        medAccessSignature: n.accessSignature,
        medDeriveKey: n.deriveKey
      };
    },
    function(t, e, r) {
      "use strict";
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.accessSignature = e.decrypt = e.encrypt = e.adamEncrypt = void 0);
      var n,
        o,
        i,
        u,
        c = p(r(23)),
        a = p(r(24));
      (e.adamEncrypt = ((n = (0, a.default)(
        c.default.mark(function t(e, r, n) {
          var o, i, u, a, s;
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 7:
                    return (
                      ...
                      t.abrupt("return", {
                        data: s,
                        MedStickerCipherAttr: { key: i, iv: u, version: f.ADAM }
                      })
                    );
                  case 11:
                    throw ((t.prev = 11),
                    (t.t0 = t.catch(4)),
                    new Error("EncryptionFailed"));
                  case 14:
                  case "end":
                    return t.stop();
                }
      ...
      function(t, e, r) {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      (n = void 0),
                        (t.t0 = a),
                        (t.next =
                          t.t0 === f.ADAM ? 4 : t.t0 === f.BRITNEY ? 6 : 8);
                      break;
                    case 4:
                      return (n = d), t.abrupt("break", 9);
                    case 6:
                      return (n = v), t.abrupt("break", 9);
                    case 8:
                      throw new Error(
                        "Wrong version is being used. Use either 'adam' or 'britney'."
                      );
                    case 9:
                      return (t.next = 11), n.importKey(i);
                    case 11:
                      return (
                        (o = t.sent),
                        (t.prev = 12),
        ...
        (e.accessSignature = ((u = (0, a.default)(
          c.default.mark(function t(e, r) {
            var n,
              o,
              i,
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      return (
                        (n = new Uint8Array(p)),
                        (o = new Uint8Array(h)),
                        (i = new Uint8Array((0, l.stringToArrayBuffer)(r))),
                        (u = (0, l.concatenateUint8Arrays)(n, o, i)),
                        (t.next = 8),
                        window.crypto.subtle.digest("SHA-256", u)
                      );
                    case 8:
                      return (
                        (a = t.sent),
                        (s = (0, l.arrayBufferToString)(a)),
                        (f = btoa(s)),
                        t.abrupt("return", d + "-sha256:" + f)
                      );
                    case 12:
                    case "end":
                      return t.stop();
      ...
      var h = (0, s.default)("scrypt"),
        d = (0, s.default)("AES-CBC"),
        v = (0, s.default)("AES-GCM");
      function y(t, e, r) {
        var n = void 0,
          o = void 0;
        switch (r) {
          case f.ADAM:
            (n = h.generateKey(e, t)), (o = h.generateKey(n, e, { dkLen: 16 }));
            break;
          case f.BRITNEY:
            (n = h.generateKey(e, t, { r: 10 })),
              (o = h.generateKey(n, e, { r: 10, dkLen: 16 }));
            break;
          default:
            throw new Error(
              "Wrong version is being used. Use either 'adam' or 'britney'."
        ...
        var i = new Uint8Array(n),
          u = new Uint8Array(o);
        return { key: i.buffer, iv: u.buffer, version: r };
      }
    },
    function(t, e, r) {
      var n =
      ...
      if (((n.regeneratorRuntime = void 0), (t.exports = r(45)), o))
    ...
    function(t, e) {
      !(function(e) {
        ...
        if (f) s && (t.exports = f);
          ...
          var w = (A.prototype = _.prototype = Object.create(y));
          (E.prototype = w.constructor = A),
            (A.constructor = E),
            (A[a] = E.displayName = "GeneratorFunction"),
    ...
    function(t, e, r) {
      r(48), r(49), r(61), r(65), r(77), r(78), (t.exports = r(2).Promise);
    },
    function(t, e) {},
    function(t, e, r) {
      "use strict";
    ...
    function(t, e, r) {
      t.exports =
        ...
        !r(17)(function() {
          return (
            7 !=
            Object.defineProperty(r(18)("div"), "a", {
              get: function() {
                return 7;
              }
            }).a
      ...
      k ||
        ...
        ((n = function(t) {
          (this._c = []),
            ...
            (this._h = 0),
            (this._n = !1);
        }).prototype = r(74)(O.prototype, {
          then: function(t, e) {
            var r = P(y(this, O));
            return (
              (r.ok = "function" != typeof t || t),
              (r.fail = "function" == typeof e && e),
              (r.domain = j ? A.domain : void 0),
              this._c.push(r),
      ...
      ((e = t.exports = function(t, e, r, l, p) {
        ...
        if (i(m)) {
          for (h = c(t.length); h > w; w++)
            if ((y = e ? g(u((d = t[w]))[0], d[1]) : g(t[w])) === s || y === f)
              return y;
        } else
        ...
        switch (t.toLowerCase()) {
          case "aes-gcm":
            return {
              ...
              exportKey: function(t) {
                return window.crypto.subtle.exportKey("raw", t);
              },
              ...
              decrypt: function(t, e, r) {
                return window.crypto.subtle.decrypt(
                  { name: "AES-GCM", iv: new Uint8Array(e) },
                  t,
                  r
                );
              }
          ...
          case "rsa-oaep":
            return {
              ...
              exportKey: function(t) {
                return window.crypto.subtle.exportKey("spki", t);
              },
              encrypt: function(t, e) {
                var r = (0, i.stringToArrayBuffer)(e);
                return window.crypto.subtle.encrypt({ name: "RSA-OAEP" }, t, r);
              },
              decrypt: function(t, e) {
                return window.crypto.subtle.decrypt({ name: "RSA-OAEP" }, t, e);
              }
            };
          case "aes-cbc":
            return {
              ...
              decrypt: function(t, e, r) {
                return window.crypto.subtle.decrypt(
                  { name: "AES-CBC", iv: new Uint8Array(e) },
                  t,
                  r
                );
              }
              ...
              generateKey: function(t, e) {
                ...
                return (
                  (0, o.default)(
                    t,
                    e,
                    (0, n.default)({ N: 16384, r: 8, p: 1, dkLen: 32 }, r),
                    function(t) {
                      i = t;
                    }
                  ),
          ...
          default:
            throw new Error(
              "The algorithm you requested is not currently supported. Supported are " +
                ["aes-gcm", "rsa-oaep", "aes-cbc", "scrypt"].map(function(t) {
                  return " " + t;
                }) +
                "."
            );
    ...
    function(t, e, r) {
      r(83), (t.exports = r(2).Object.assign);
    },
    function(t, e, r) {
      var n = r(5);
      n(n.S + n.F, "Object", { assign: r(84) });
    },
    function(t, e, r) {
      "use strict";
      var n = r(27),
        ...
        t.exports =
          ...
          function(t, r, n, o, i, u, c, a) {
            ...
            function s(t) {
              ...
              var p,
                h = t.length % 64,
                d = (t.length / 536870912) | 0,
                v = t.length << 3,
                y = h < 56 ? 56 : 120,
                m = t.slice(t.length - h, t.length);
              for (m.push(128), p = h + 1; p < y; p++) m.push(0);
              return (
                m.push((d >>> 24) & 255),
                m.push((d >>> 16) & 255),
                m.push((d >>> 8) & 255),
            ...
            function f(t, e, r) {
              t.length > 64 &&
                (t = s(t.push ? t : Array.prototype.slice.call(t, 0)));
              var n,
                o = 64 + e.length + 4,
                i = new Array(o),
                u = new Array(64),
              ...
              for (n = 0; n < e.length; n++) i[64 + n] = e[n];
              for (n = o - 4; n < o; n++) i[n] = 0;
              for (n = 0; n < 64; n++) u[n] = 92;
              for (n = 0; n < t.length; n++) u[n] ^= t[n];
              function a() {
                for (var t = o - 1; t >= o - 4; t--) {
                  if ((i[t]++, i[t] <= 255)) return;
                  i[t] = 0;
                }
              }
              for (; r >= 32; )
                a(), (c = c.concat(s(u.concat(s(i))))), (r -= 32);
              return (
                r > 0 && (a(), (c = c.concat(s(u.concat(s(i))).slice(0, r)))), c
              );
            }
            function l(t, e, r, n) {
              var o,
            ...
            function d(t, e, r, n, o) {
              p(t, 0, e, r + 16 * (2 * o - 1), 16);
              for (var i = 0; i < 2 * o; i += 2)
                l(t, e, r + 16 * i, n + 8 * i),
                  l(t, e, r + 16 * i + 16, n + 8 * i + 16 * o);
            }
            function v(t, e, r) {
              return t[e + 16 * (2 * r - 1)];
            }
            ...
            if (m < 1) throw new Error("scrypt: invalid p");
            ...
            "string" == typeof t && (t = y(t)),
              ...
              "undefined" != typeof Int32Array
                ? ((w = new Int32Array(64 * o)),
                  (b = new Int32Array(32 * E * o)),
                  (_ = new Int32Array(16)))
                : ((w = []), (b = []), (_ = new Array(16))),
              (x = f(t, r, 128 * m * o));
            var A = 0,
            ...
            var P = void 0 !== e ? e : setTimeout;
            function k(t, e, r, n, o) {
              !(function i() {
                P(function() {
                  n(t, t + r < e ? t + r : e), (t += r) < e ? i() : o();
                });
              })();
            }
            function M(e) {
            ...
            "function" == typeof u && ((a = c), (c = u), (u = 1e3)),
              u <= 0
                ? (function() {
                    for (var t = 0; t < m; t++)
                      S(128 * t * o), O(0, E), j(0, E), L(128 * t * o);
                    c(M(a));
                  })()
                : (function t(e) {
                    S(128 * e * o),
                      k(0, E, 2 * u, O, function() {
                        k(0, E, 2 * u, j, function() {
                          L(128 * e * o),
                            e + 1 < m
                              ? P(function() {
                                  t(e + 1);
